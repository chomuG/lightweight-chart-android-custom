/*!
 * @license
 * TradingView Lightweight Charts v5.0.8-dev+202508040553
...
(function () {
    ...
    ***************************************************************************** */
    ...
    /// <reference types="_build-time-constants" />
    // 5.0+ Series Types Compatibility Layer
    var LineSeries = 'Line';
    var AreaSeries = 'Area';
    var BaselineSeries = 'Baseline';
    var BarSeries = 'Bar';
    var CandlestickSeries = 'Candlestick';
    var HistogramSeries = 'Histogram';
    /**
     * Returns the current version as a string. For example `'5.0.8'`.
     */
    function version() {
        return "5.0.8-dev+202508040553";
    }
